        ...
        userType === "doctor"
          ? {
              ...
              hospitalInfo: {
                ...
                address: formData.hospitalInfo?.address || "",
                city: formData.hospitalInfo?.city || "",
              },
              availabilityRange: {
                startDate: formData.availabilityRange?.startDate || "",
                endDate: formData.availabilityRange?.endDate || "",
                excludedWeekdays:
                  formData.availabilityRange?.excludedWeekdays || [],
              },
              dailyTimeRanges: Array.isArray(formData.dailyTimeRanges)
                ? formData.dailyTimeRanges.filter(
